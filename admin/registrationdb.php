...
if (isset($_POST['submit'])) {
    ...
    $insertquery = "insert into registration(name , email , phone , password , cpassword) values('$name','$email','$phone','$password','$cpassword')";
...
?>  
  <tbody>
    <tr>
      ...
      <td><a style="text-decoration: none; color: red;" href="regestrationdelete.php?id= <?php echo $arrdata['id'] ?>">Delete</a></td>
    </tr>
  </tbody>
<?php }  ?>
</table>
