...
<?php session_start();    ?>
 ...
 <body>
 	...
 	$emailsearch = "select * from adminregister where email = '$email'";
        ...
        <div class="container">
            ...
            <form class="form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" id="form" method="POST">
                ...
                <input type="submit" value="Login Now" class="btn" name="submit">
                    ...
                    <div class="form-group p-10">
                <p style="text-align: center; padding: 15px;">Not have an account? <a style="text-decoration: none;" href="adminregister.php">Register</a></p></div>
            </form>
        </div>
    </main>
