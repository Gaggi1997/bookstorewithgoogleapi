...
if (isset($_POST['submit'])) 
{
  ...
  $Exp = $_POST['exp'];
  $Cvv = $_POST['cvv'];
  $insertquery = "insert into checkout(name,email,card_name,card_number,address,pincode,phno,exp,cvv) values('$Name','$Email','$cname','$cnumber','$Address','$Pincode','$Phno','$Exp','$Cvv')";
  $query = mysqli_query($dbc,$insertquery);
  if ($query) {
    ?>
    <script>alert('Thank you for transaction,We will contact you Shortly!')</script>
    <?php
  }else{
    ?>
                  ...
                  <div class="col-lg-5">
                        <div class="row px-2">
                            ...
                            <form action="#" method="POST">
                                ...
                                <input type="text" id="cname" name="name" placeholder="Johnny Doe">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-control-label">Email</label>
                                <input type="text" id="cnum" name="email" placeholder="1111 2222 3333 4444">
                            </div>
                        </div>
                        <div class="row px-2">
                            <div class="form-group col-md-6">
                                <label class="form-control-label">Name on Card</label>
                                <input type="text" id="cname" name="card_name" placeholder="Johnny Doe">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row px-2">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" id="cnum" name="address" placeholder="ABC street,ON">
                            </div>
                        </div>
                            <div class="row px-2">
                            <div class="form-group col-md-6">
                                <label class="form-control-label">Pincode</label>
                                <input type="text" id="exp" name="pincode" placeholder="K8G Y8K">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="form-control-label">Phno.</label>
                                <input type="text" id="cnum" name="phno" placeholder="+6478937864">
                            </div>
                        </div>                               
                        <div class="row px-2">
                            <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-4 mt-2">
                        <button class="btn-block btn-blue" name="submit"  style="width:50%; height:30%; margin-top:20%; margin-left:20%;">
                            <span>
